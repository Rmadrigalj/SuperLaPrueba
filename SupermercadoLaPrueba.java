...
public class SupermercadoLaPrueba {
    ...
    private static Pasillo[] pasillos = new Pasillo[10];
    private static Compra[] compras = new Compra[MAX_COMPRAS];
...
class Pasillo {
    private Producto[] productosRegistrados;
